...
Komennon `-A` ja `-p0-` tarkoittaa sitä, että kaikki portit skannataan. Skannaus kesti pitkään 207.70 sekuntia. Alla pieni pätkä skannaustuloksen alusta.
...
Skannauksesta ilmeni paljon uutta tietoa. Tässä niistä muutamia:
- avonaisia tcp-portteja kuten 21, 22, 23, 25, 53, 80 ja 5432
  - esimerkiksi portti 23 ei pitäisi olla auki > haavoittuvuus
- 

Skannauksen aikana Wiresharkissa liikkui tuhansia paketteja. Tuloksia silmäillessä näkyi ainakin TCP, UDP, FTP, HTTP ja SSDP protokollien paketteja. Tulokset näyttivät pääosin tältä:
