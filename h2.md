...
Muuttuja enc saa määritellyn arvon, tuodaan base64 Pythoniin, suoritetaan enc arvon purkaminen ja tallennetaan arvo key muuttujaan (tästä myös demo). Lipun saa kun ajaa tämän komennon:
