...
Indicator = piece of information that describes objectively an intrusion
- Atomic = indicator that can't be broken down or it loses its meaning in the context
- Computed = indicators derived from incident data
- Behavioral = indicator that is a collection of computed and atomic indicators
