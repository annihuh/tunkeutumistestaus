...
Laajassa porttiskannauksessa näkyy paljon enemmän tietoa asennuksen jälkeen. Tuloksesta näkee, että portti 22 on auki SSH:n asennuksen takia, uutta järjestelmätietoa sekä TCP/IP sormenjälkiä. 
