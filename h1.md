...
Tehtävässä demonstroidaan, miten HTTP toimii. Ensimmäisessä tehtävässä server palauttaa annetun nimen väärinpäin.
...
Osiossa kolme kysytään, mitä komentoa tehtävässä käytettiin. Vastaus oli POST. "Taikanumeron" löysin inspect-työkalulla, vastaus oli 69. 
