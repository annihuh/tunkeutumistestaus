...
Ajoin hashcat-komennon, joka käyttää MD5 hash-tyyppiä `-m 0`, ratkaistakseen annettua hashia. Komento käy läpi rockyou.txt-tiedostoa, missä yleisimmät salasanat ovat. Lopuksi tulos tallennetaan `-o` tiedostoon nimeltä salasana.
